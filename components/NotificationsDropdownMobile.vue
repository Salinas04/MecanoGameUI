<template>
  <div class="w-full">
    <!-- Header -->
    <div class="border-b border-gray-200 dark:border-gray-700 flex justify-between items-center pb-3">
      <h3 class="text-lg font-semibold text-gray-800 dark:text-white">Notifications</h3>
      <div class="flex items-center">
        <button 
          v-if="notifications.length > 0 && hasUnread" 
          @click="markAllAsRead" 
          class="text-sm text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 mr-3"
        >
          Mark all as read
        </button>
        <button 
    ...
    <!-- Footer -->
    <div class="pt-3 border-t border-gray-200 dark:border-gray-700 text-center mt-3">
      <NuxtLink to="/friends" class="text-sm text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300" @click="$emit('close')">
