...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</main><footer class="bg-glass-light dark:bg-glass-dark backdrop-blur-md border-t border-white/10 dark:border-gray-800/30 shadow-glass-inner py-6"><div class="container mx-auto px-4 text-center text-gray-600 dark:text-gray-400"><p>© ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} TypingRush. All rights reserved.</p></div></footer>`);
      if (showRules.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({
...
//# sourceMappingURL=default-COrQGBty.js.map
